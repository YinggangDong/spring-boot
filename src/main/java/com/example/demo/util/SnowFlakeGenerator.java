...
/**
 * SnowFlakeGenerator 类是 雪花算法生成分布式id
 *
 * @author dongyinggang
 * @date 2021-04-27 10:41
 **/
public class SnowFlakeGenerator {
     ...
     * 作者写代码时的时间戳
     */
    private final static long START_STAMP = 1619491507078L;
...
//                throw new IllegalStateException("sequence over flow");
    ...
    public static void main(String[] args) {
        SnowFlakeGenerator snowFlakeGenerator = new Factory().create(1L,1L);
        int i = 0;
        while(i<1000){
